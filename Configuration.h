...
#define DELTA_DIAGONAL_ROD 360.211 // basic 361.89

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 242.52 // mm                                             
...
#define MANUAL_Z_HOME_POS 336.8 //336.8 for XCR-Z GLASS 0.4 NOZZLES , 330.33 FOR XCR-Z CNC , 328.33 FOR XCR-Z  , 357 for MK2-0.4 SET // For delta: Distance between nozzle and print surface after homing.
...
#define EXTRUDER_OFFSET_Y {0.0, 15.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
