...
static void lcd_bed_leveling_menu()
{
  ...
  if (!(movesplanned() || IS_SD_PRINTING)) 
  {
	MENU_ITEM(gcode, MSG_PREHEAT_NOZZLE, PSTR("M104 S200 T0"));
	MENU_ITEM(gcode, MSG_PREHEAT_NOZZLE1, PSTR("M104 S200 T1"));
	MENU_ITEM(function, MSG_AUTO_LEVEL, lcd_g29);
	MENU_ITEM(submenu, MSG_ADJUST_ZOFFSET, lcd_adjuest_zoffet_menu);
	MENU_ITEM(function, MSG_COOLDOWN, lcd_cooldown);
    MENU_ITEM_EDIT_CALLBACK(float32, MSG_ZOFFSET, &z_offset, -20, 20, Config_StoreSettings);  // ini val -2,2 ... edit 20180108 poyuan
...
static void lcd_preheat1_settings_menu()
{
    ...
    MENU_ITEM_EDIT(int3, MSG_NOZZLE01, &plaPreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#if TEMP_SENSOR_BED != 0
...
static void lcd_preheat2_settings_menu()
{
    START_MENU();
	MENU_ITEM(back, MSG_PREHEAT_SETTINGS, lcd_preheat_settings_menu);
    MENU_ITEM_EDIT(int3, MSG_NOZZLE01, &absPreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#if TEMP_SENSOR_BED != 0
